...
""", unsafe_allow_html=True)
    ...
    <div style="margin-top:18px;text-align:center;font-size:0.875rem;color:#64748b;font-family:'Inter',sans-serif;">
      ...
      <a href="/?nav=signup" style="color:#2563EB;font-weight:600;text-decoration:none;">Sign up for free</a>
    </div>
  </div>
...
""", unsafe_allow_html=True)
    ...
    st.markdown("""
      <div style="margin-top:18px;text-align:center;font-size:0.875rem;color:#64748b;font-family:'Inter',sans-serif;">
        ...
        <a href="/?nav=login" style="color:#2563EB;font-weight:600;text-decoration:none;">Log in</a>
      </div>
    </div>
  </div>
  <div class="auth-footer">
    <a href="#" style="color:#94a3b8;text-decoration:none;margin:0 6px;">Help</a>·
    <a href="#" style="color:#94a3b8;text-decoration:none;margin:0 6px;">Privacy</a>·
    <a href="#" style="color:#94a3b8;text-decoration:none;margin:0 6px;">Terms</a><br>
