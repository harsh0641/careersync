...
Persistent login via st.query_params ?uid= — survives refresh.
No components.html — pure Streamlit only.
"""
...
# ══════════════════════════════════════════════════════════════════════════════
# PERSISTENT LOGIN — restore from ?uid= query param on every refresh
# ══════════════════════════════════════════════════════════════════════════════
def _restore():
...
# Keep ?uid= in URL on every load so refresh always works
...
.li-btn{display:inline-flex;align-items:center;gap:4px;background:#fff;
  ...
  padding:2px 8px;font-size:0.68rem;font-weight:700;text-decoration:none;margin-top:3px;}
...
with cr:
    st.markdown("<h3 style='font-size:1.05rem;font-weight:700;color:#0f172a;margin-bottom:12px;'>"
                "Credit Usage</h3>", unsafe_allow_html=True)
...
# MANAGE APPLICATIONS
# ══════════════════════════════════════════════════════════════════════════════
st.markdown("<h3 style='font-size:1.1rem;font-weight:700;color:#0f172a;'>⚙️ Manage Applications</h3>",
            unsafe_allow_html=True)
