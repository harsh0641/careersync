...
with st.sidebar:
    ...
    [data-testid="stSidebar"] .stButton>button{
      ...
      padding:9px 12px!important;border-radius:9px!important;width:100%!important;
      font-family:'DM Sans',sans-serif!important;transition:background 0.13s,color 0.13s!important;}
    ...
    for icon, label, path, is_active in nav_items:
        ...
        style = ("background:rgba(37,99,235,0.08);color:#2563EB;font-weight:700;"
                 if is_active else "color:#64748b;font-weight:500;")
        st.markdown(f"""
        <div style="display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:9px;
                    font-size:0.875rem;font-family:'DM Sans',sans-serif;margin-bottom:2px;{style}">
          <span class="mi" style="font-size:20px;font-variation-settings:'FILL' {fill},'wght' 400,'GRAD' 0,'opsz' 24;">{icon}</span>
          {label}
